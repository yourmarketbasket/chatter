  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final oneToOneChats = dataController.conversations;
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final otherParticipant = conversation.participants.firstWhere((p) => p.id != currentUserId);

            final name = otherParticipant.name;
            final avatarUrl = otherParticipant.avatar;
            final receiverId = otherParticipant.id;
            ...
            if (lastMessage != null) {
              timestamp = DateFormat('h:mm a').format(lastMessage.createdAt.toLocal());
            } else {
              timestamp = '';
            }
